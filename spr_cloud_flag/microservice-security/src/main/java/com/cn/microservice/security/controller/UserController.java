...
//    @PreAuthorize(value = "hasRole('ROLE_permission_query')")
    @PreAuthorize("hasPermission('/queryUsers','ROLE_permission_query')")
...
//    @PreAuthorize(value = "hasRole('ROLE_permission_add')")
    @PreAuthorize("hasPermission('/addUsers','ROLE_permission_add')")
...
//    @PreAuthorize(value = "hasRole('ROLE_permission_del')")
    @PreAuthorize("hasPermission('/delUsers','ROLE_permission_del')")
...
//    @PreAuthorize(value = "hasRole('ROLE_permission_edit')")
    @PreAuthorize("hasPermission('/editUsers','ROLE_permission_edit')")
...
//    @PreAuthorize(value = "hasRole('ROLE_permission_getIp')")
    @PreAuthorize("hasPermission('/getUserIp','ROLE_permission_getIp')")
